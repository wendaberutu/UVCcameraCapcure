...
//    private ImageView[] capturedViews = new ImageView[3];
//
...
//
//        capturedViews[0] = findViewById(R.id.capturedCam1);
//        capturedViews[1] = findViewById(R.id.capturedCam2);
//        capturedViews[2] = findViewById(R.id.capturedCam3);
//
...
//        for (int i = 0; i < 3; i++) {
//            if (!UsbCameraMap.isSlotUsed(this, i)) {
...
//
//    // --------------------------------------------------------------------
//    // CAPTURE → TAMPILKAN DI SLOT MASING-MASING
//    // --------------------------------------------------------------------
//    private void captureAndNext() {
//        if (activeCamera == null || activeDevice == null) {
...
//
//        if (bmp != null) {
//            Log.d(TAG, "Captured slot " + slot);
//            capturedViews[slot].setImageBitmap(bmp);
//            capturedViews[slot].setVisibility(ImageView.VISIBLE);
//        }
//
//        closeActiveCamera();
//        tryProcessQueue();
